        ...
        <div class="row  pt-2 pb-2">
            ...
            <div class="col-xl-2 col-sm-4 p-1 px-1">
                <div class="card border-0">
                    ...
                    <div class="card-body">
                        <a href="{{url('/chitiet',$danhchoban->id)}}" class="text-decoration-none " style="font-size: 13px; color: gray;">{{$giamgia[0]->name}}</a>
        ...
        <div class="row  pt-2 pb-2">
            ...
            <div class="col-xl-2 col-sm-4 p-1 px-1">
                <div class="card border-0">
                    ...
                    <div class="card-body">
                        <a href="{{url('/chitiet',$hot->id)}}" class="text-decoration-none " style="font-size: 13px; color: gray;">{{$giamgia[0]->name}}</a>
                        <div class="row d-flex">
                            <div class="col-sm-10">
                                <p>
...
<section>
    <div class="container bg-success-subtle px-4 pb-2" style="border-radius: 5px;">
        <h3 class="text-center pt-2">SẢN PHẨM GIẢM GIÁ</h3>
        {{-- <div class="row  pt-2 pb-2">
            ...
            <div class="col-xl-2 col-sm-4 p-1 px-1">
                <div class="card border-0">
                    ...
                    <div class="card-body">
                        <a href="{{url('/chitiet',$giamgia->id)}}" class="text-decoration-none " style="font-size: 13px; color: gray;">{{$giamgia[0]->name}}</a>
                        <div class="row d-flex">
                            <div class="col-sm-10">
                                <p>
                                    <span style="color: red;"><b>{{number_format($giamgia->priceSale)}}.000₫</b></span><br>
                                    <span><del>{{number_format($giamgia->price)}}.000 ₫</del></span>
                                </p>
                            </div>
                            <div class="col-sm-2">
