                ...
                <div class="boxloai mb-4 bg-white">
                    ...
                    <div class="danhmuc">
                        @foreach ($tacgia as $tg)
                            <label><input type="checkbox" name="tacgia" value="tacgia{{ $tg->id }}">
                                {{ $tg->name }}</label>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="thanhchucnang bg-white">
                    <div class="row p-3">
                        ...
                        <div class="col-sm-5">
                            <form action="">
                                @csrf
                                <select name="sort" id="sort" class="form-select thanhsapxep"
                        ...
                        @foreach ($products as $sanpham)
                            <div class="col-md-6 col-lg-4 col-xl-3 p-2 sanpham mb-2">
                                <div class="boxsanpham  p-2"><a href="{{ url('/chitiet/' . $sanpham->id) }}">
                                        <div class="img">
                                            <img src="{{ $sanpham->img }}" alt="{{ $sanpham->name }}" width="200px"
                                                height="200px">
                                        </div>
                                        <div class="title">
                                            <h3>
                                        ...
                                        <div class="row">
                                            <div class="col-8 gia">
                                                <span>{{ number_format($sanpham->priceSale) }}.000 đ</span><br>
                                                <p><del>{{ number_format($sanpham->price) }}.000 đ</del></p>
                                            </div>
                                            <div class="col-4">
                                                <a href="{{ route('add_to_cart', $sanpham->id) }}"
