...
<div class="container px-0 pt-3 pb-3">
  ...
  Trang chủ
                ...
                <div class="col-lg-6 right p-4">
                    ...
                    <div class="row contentintro p-4">
                        <div class="col-xl-6 p-2">
                            <i class="fa fa-star mx-2"></i>Chúng tôi có đủ khả năng
                        </div>
                        <div class="col-xl-6 p-2">
                            <i class="fa fa-star mx-2"></i>Thiết bị công nghệ hiện đại
                        </div>
                        <div class="col-xl-6 p-2">
                            <i class="fa fa-star mx-2"></i>Sáng tạo và năng động
                        </div>
                        <div class="col-xl-6 p-2">
                            <i class="fa fa-star mx-2"></i>Mày mò và không ngừng học hỏi
                        </div>
    ...
    <div class="container pb-5">
        <h1 class="text-center">Đội ngũ phát triển Website</h1>
    </div>
    <section>
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-lg-2 d-none d-lg-block">
                    <img src="/img/khoa.jpg" alt="" class="img-fluid" style="border-style: solid; border-color: #f27024; border-radius: 10%;">
                    <p>Phan Đăng Khoa</p>
                </div>
                <div class="col-lg-2 d-none d-lg-block">
                    <img src="/img/khai.jpg" alt="" class="img-fluid"  style="border-style: solid; border-color: #f27024; border-radius: 10%;">
                    <p>Nguyễn Văn Khải</p>
                </div>
                <div class="col-lg-2 d-none d-lg-block">
                    <img src="/img/kha.jpg" alt="" class="img-fluid"  style="border-style: solid; border-color: #f27024; border-radius: 10%;">
                    <p>Võ Đình Kha</p>
                </div>
                <div class="col-lg-2 d-none d-lg-block">
                    <img src="/img/phuc.jpg" alt="" class="img-fluid" style="border-style: solid; border-color: #f27024; border-radius: 10%;" >
                    <p>Lê Nguyễn Hoàng Phúc</p>
                </div>
                <div class="col-lg-2 d-none d-lg-block">
                    <img src="/img/phong.jpg" alt="" class="img-fluid" style="border-style: solid; border-color: #f27024; border-radius: 10%;" >
                    <p>Võ Hoàng Phong</p>
                </div>
                <div class="col-lg-2 d-none d-lg-block">
                    <img src="/img/an.jpg" alt="" class="img-fluid" style="border-style: solid; border-color: #f27024; border-radius: 10%;" >
                    <p>Nguyễn Ngọc Thiên Ân</p>
                </div>
            </div>
        </div>
    </section>
